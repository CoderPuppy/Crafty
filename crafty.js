...
if(Object.defineProperty) {
    Object.defineProperty(Crafty, "components", {
      get: function() {return components;},
      set: function(v) {components = v;}
    });
} else {
    Crafty.__defineSetter__("components", function(v) {components = v;});
    Crafty.__defineGetter__("components", function() {return components;});
}
...
Crafty.extend({
	...
	*/
	stop: function() {
          var hs = Object.keys(handlers).map(function(h) {return {n:h, h:handlers[h]};}).filter(function(h) {return !!h.h.global;}).map(function(h) {return {name: h.n, global: h.h.global};});
